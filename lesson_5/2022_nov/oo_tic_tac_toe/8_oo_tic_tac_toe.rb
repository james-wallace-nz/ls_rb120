...
class Board
  ...
  def detect_winner
    WINNING_LINES.each do |line|
      ...
      # can use hash `values_at` method
      # can use splat operator to explode out array values into parameter list that can pass into values_at
  ...
  # squares is an array of square objects calling map on each of them to return a new array of markers and then count those
